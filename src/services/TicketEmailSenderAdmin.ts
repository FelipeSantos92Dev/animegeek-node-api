...
export default async function TicketEmailSenderAdmin(
  ...
  try {
    ...
    const message = {
      from: email,
      to: 'animegeek.ingressos@gmail.com',
      subject: 'Nova Compra Via Cartão de Crédito',
                                                                        ...
                                                                        >
                                                                          <span
                                                                            style="
                                                                              font-size: 18px;
                                                                            "
                                                                            >Ingressos adquiridos por ${name}</span
                                                                          >
                                                                        </div>
                                                                        <div
                                                                          style="
                                                                        ...
                                                                        >
                                                                          <span
                                                                            style="
                                                                              font-size: 18px;
                                                                            "
                                                                            >Agora é só enviar para o e-mail ${emailSender}</span
                                                                          >
                                                                        </div>
                                                                      ...
                                                                      >
                                                                        <tbody>
                                                                          <tr>
                                                                            ...
                                                                            >
                                                                              <a
                                                                                href="https://dashboard-ignite.vercel.app/login"
                                                                                style="
